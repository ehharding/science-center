...
// Enforces certain selectors to be only in camelCase notation. We use these for id selectors and classname selectors.
...
export default {
  ...
  rules: {
    // Enforces element classnames to be camelCase
    ...
    // Disables the Level-4 Media Queries; They're more exotic and less known.
